...
export async function ImportantKnowledge() {
    ...
    return (
        <>
            <section className="text-white isolate bg-cover pt-52 bg-left-top relative overflow-hidden lg:rounded-xl lg:py-32 lg:mx-20 lg:bg-important-pattern bg-important-pattern-small">
