    ...
    return (
        <div className="relative w-screen">
            ...
            <div className="relative overflow-hidden w-full h-full pt-32 pb-20">
                <div
                    className="absolute w-[300px] h-[300px] -right-[80px] -bottom-[100px] bg-blue-800 rounded-full opacity-50 blur-[150px] -z-10 "
                />

                <div
                    className="absolute lg:block hidden w-[200px] h-[300px] top-0 -left-[80px] bg-blue-800 rounded-full opacity-50 blur-[150px] -z-10 "
                />
