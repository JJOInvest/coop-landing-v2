...
export async function BestMinds() {
    ...
    return (
        <section className="pt-20 pb-[120px] relative overflow-hidden bg-background lg:p-0 lg:flex lg:items-center min-h-screen">
            <div className="absolute bg-blue-800 w-[200px] h-80 opacity-20 blur-[70px] -top-[15px] left-[30px]" />

            <div className="container flex flex-col gap-[94px] lg:gap-32 lg:flex-row lg:items-center">
